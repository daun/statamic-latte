...
describe('content wrap', function () {
    ...
    test('normalizes s() tag results into Content objects', function () {
        $this->latte(
    ...
    test('unwraps Content before reaching a modifier', function () {
    ...
    test('unwraps deeply nested data back into Antlers (reverse)', function () {
        $template = <<<'LATTE'
            {antlers}
    ...
    test('loops list tag results (lists are plain arrays)', function () {
        $this->latte(
